...
# 	this package furthermore provides a degree of TWO-WAY translation 
# 	consistency through lang_of(<keyword>, :from => :<language_tag>) 
# 	so that I18n.lang_of("interdire", {:from => :en}) must produce :it 
# 	where I18n.t("ban", {:to => :it}) produces "interdire" (and not :fr)
